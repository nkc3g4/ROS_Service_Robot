...
class recognizer(object):
    ...
    def __init__(self):
        # Start node
        rospy.init_node("pocketSphinx_recognizer_node")

        if rospy.has_param('~Wakeup_Topic'):
            pass
        else:
            rospy.set_param('~Wakeup_Topic', '/voice_system/wakeup_topic')

        self.Topic = rospy.get_param('~Wakeup_Topic')
    ...
    def start_recognizer(self):
        ...
        self.asr.set_property('lm', '/usr/share/pocketsphinx/model/lm/zh_CN/zh_broadcastnews_64000_utf8.DMP')
        self.asr.set_property('hmm', '/usr/share/pocketsphinx/model/hmm/zh/zh_broadcastnews_ptm256_8000')
