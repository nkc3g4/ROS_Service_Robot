...
class PositionNav():  
    def __init__(self):  
        ...
        locations['one'] = Pose(Point(-0.601,-0.00146,0.0), Quaternion(0.0,0.0,0.06178,0.9981))
        locations['two'] = Pose(Point(1.0465,0.2962,0.0), Quaternion(0.0,0.0,0.0714,0.9974))
        locations['three'] = Pose(Point(1.5603,-2.0893,0.0), Quaternion(0.0,0.0,-0.6353,0.7723))
        locations['four'] = Pose(Point(-0.1766,-2.7695,0.0), Quaternion(0.0,0.0,0.7641,0.645))
        locations['back'] = Pose(Point(-0.601,-0.00146,0.0), Quaternion(0.0,0.0,0.06178,0.9981))
