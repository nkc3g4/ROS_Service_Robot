...
class PositionNav():  
    def __init__(self):  
        ...
        locations = dict()  
        locations['one'] = Pose(Point(0.029, -0.583, 0.000), Quaternion(0.000, 0.000, -0.058, 0.998))  
        locations['two'] = Pose(Point(0.102, 0.664, 0.000), Quaternion(0.000, 0.000, -0.001, 0.999))  
        locations['three'] = Pose(Point(0.113, -0.689, 0.000), Quaternion(0.000, 0.000, -0.070, 0.997))  
        locations['four'] = Pose(Point(0.328, -0.029, 0.000), Quaternion(0.000, 0.000, -0.006, 0.999))  
