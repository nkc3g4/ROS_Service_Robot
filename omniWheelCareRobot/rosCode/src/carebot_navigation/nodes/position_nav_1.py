...
class PositionNav():  
    def __init__(self):  
        ...
        locations['three'] =  Pose(Point(1.0602,0.5279,0.0), Quaternion(0.0,0.0,0.2534,0.9674))

        locations['four'] =  Pose(Point(1.0602,0.5279,0.0), Quaternion(0.0,0.0,0.2534,0.9674))
        locations['back'] =  Pose(Point(-0.4758,-0.1609,0.0), Quaternion(0.0,0.0,-0.0333,0.9994))
	...
	# 2018.8.6 backhome code
        ...
        location = ""  
        last_location = ""  
        sequeue=['one','two-1','two-2', 'two','three-1','three-2', 'three', 'four', 'back'] 
