...
"""
    tree_add_remove.py - Version 1.0 2013-09-22
    
    Demonstrate dynamically removing and adding nodes to a behavior tree.
...
class AddRemoveExample():
    def __init__(self):
        ...
        COUNT_TO_10 = Count("COUNT", n_count)
        ...
        # Set a flag to remove or add back the couting task
        remove = True
